...
public class Tracking____ {
    ...
    @Expose
    private EventProperty____ eventProperty;
    ...
    public EventProperty____ getEventProperty() {
        return eventProperty;
    }

    public void setEventProperty(EventProperty____ eventProperty) {
