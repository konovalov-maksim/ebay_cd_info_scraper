...
public class Tracking_______ {
    ...
    @Expose
    private EventProperty_______ eventProperty;
    ...
    public EventProperty_______ getEventProperty() {
        return eventProperty;
    }

    public void setEventProperty(EventProperty_______ eventProperty) {
