...
public class Tracking_____ {
    ...
    @Expose
    private EventProperty_____ eventProperty;
    ...
    public EventProperty_____ getEventProperty() {
        return eventProperty;
    }

    public void setEventProperty(EventProperty_____ eventProperty) {
